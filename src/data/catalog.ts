...
export const DEFAULT_SETTINGS: CatalogSettings = {
  ...
  siteTitle: 'Sahara Electronic – Məhsul Kataloqu',
  siteSubtitle: 'Məişət texnikası modelləri və zəmanətli satış mərkəzi',
  headerCaption: 'Rəsmi məhsul kataloqu',
  catalogHeading: 'Bütün məhsullar',
  catalogSubheading: 'Modellərə və texniki xüsusiyyət sahələrinə baxın',
  heroBannerTitle: 'Premium İtalyan ARDO & Məişət Texnikası',
  heroBannerSubtitle: 'Eleqant dizayn, yüksək enerji səmərəliliyi və 3 ilə qədər rəsmi zəmanət',
  footerAbout: 'Sahara Electronics rəsmi ARDO, Lotus və Artel məhsullarının zəmanətli satış mərkəzidir.',
