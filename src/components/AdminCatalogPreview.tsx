...
export const AdminCatalogPreview: React.FC<{ catalog: CatalogData; theme: ThemeColors; onClose: () => void }> = ({ catalog, theme, onClose }) => {
  ...
  const { containerRef: previewFiltersRef, scrollItemIntoView, dragProps, hasMoved } = useHorizontalScroll({
  ...
  return <div className="admin-preview-overlay" style={{ background: theme.bg }}>
    ...
    <main>
      ...
      <div ref={previewFiltersRef} {...dragProps} className="preview-filters no-scrollbar" style={{ cursor: 'grab' }}>
