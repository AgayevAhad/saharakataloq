...
export const Input: React.FC<InputProps> = ({
  ...
  return (
    <div className={`sahara-input-group ${className}`} style={{ display: 'flex', flexDirection: 'column', gap: '6px', width: '100%' }}>
      {label && (
        <label
          htmlFor={inputId}
      ...
      {error && (
        <span id={errorId} role="alert" style={{ fontSize: '12px', color: '#ef4444', fontWeight: 500 }}>
          {error}
        </span>
      )}
