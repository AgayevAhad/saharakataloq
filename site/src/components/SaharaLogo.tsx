...
export const SaharaLogo: React.FC<SaharaLogoProps> = ({
  ...
  return (
    <>
      ...
      >
        <ShimmerImage src={logoSrc} alt="Sahara Electronics" className="sahara-logo-img" />
      </span>
      ...
      {modalOpen && (
        ...
        >
          ...
          >
            ...
            <div style={{ width: '100%', maxWidth: '420px', margin: '10px 0 20px' }}>
              <ShimmerImage
                src={logoSrc}
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              >
                Məişət Texnikası və İqlim Sistemləri
              </p>
              <span
                style={{
                  display: 'inline-flex',
