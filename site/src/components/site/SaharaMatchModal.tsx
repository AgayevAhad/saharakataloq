...
export const SaharaMatchModal: React.FC<SaharaMatchModalProps> = ({
  ...
  return (
    <Modal
      ...
      description="Ehtiyaclarınıza və məkanınıza ən uyğun modeli tapın"
      maxWidth="620px"
    >
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    backgroundColor:
                      selectedCategory === item.id ? 'rgba(220, 38, 38, 0.08)' : theme.bgCard,
                    color: theme.text,
                    fontWeight: 600,
                    fontSize: '13px',
                    cursor: 'pointer',
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    backgroundColor:
                      familySize === item.id ? 'rgba(220, 38, 38, 0.08)' : theme.bgCard,
                    color: theme.text,
                    fontWeight: 600,
                    fontSize: '14px',
                    cursor: 'pointer',
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    backgroundColor:
                      priority === item.id ? 'rgba(220, 38, 38, 0.08)' : theme.bgCard,
                    color: theme.text,
                    fontWeight: 600,
                    fontSize: '14px',
                    cursor: 'pointer',
