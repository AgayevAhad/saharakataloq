...
export const SnapshotManager: React.FC<Props> = ({ theme, csrfToken, showToast, onRestore }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ fontSize: '13px' }}>
          ...
          <span style={{ color: theme.textMuted }}>
            Canlı yayıma buraxılan və ya əllə yadda saxlanılan hər addımda avtomatik nüsxə
            yaradılır. İstədiyiniz an siyahıdan hər hansı nüsxəni seçib{' '}
            <strong>"Bu Versiyaya Qayıt"</strong> düyməsilə tam bərpa edə bilərsiniz.
          </span>
        </div>
      </div>
      ...
      {loading && snapshots.length === 0 ? (
        ...
        >
          ...
          <p style={{ fontSize: '13px', color: theme.textMuted, margin: '0 0 16px' }}>
            Kataloqun hazırkı vəziyyətini qorumaq üçün yuxarıdakı "Yeni Nüsxə Saxla" düyməsinə
            klikləyin.
          </p>
        </div>
      ) : (
      ...
      {createModalOpen && (
        <div className="admin-status-modal-backdrop" onClick={() => setCreateModalOpen(false)}>
          <div
      ...
      {restoreModalOpen && selectedSnapshot && (
        <div className="admin-status-modal-backdrop" onClick={() => setRestoreModalOpen(false)}>
          <div
            className="admin-status-modal"
            onClick={(e) => e.stopPropagation()}
            style={{
          ...
          >
            ...
            <div style={{ padding: '16px' }}>
              ...
              <p style={{ fontSize: '13px', lineHeight: 1.5, margin: '0 0 16px' }}>
                Bu nüsxəni bərpa etdiyiniz zaman, kataloqun bütün məhsulları, şəkilləri, kəsimləri
                və qiymətləri seçilmiş tarixdəki halına qaytarılacaqdır.
                <br />
                <br />
                <strong style={{ color: '#16a34a' }}>
                  ✓ Təhlükəsizlik Zəmanəti: Cari vəziyyətiniz itməyəcək — sistem bərpadan öncə
                  avtomatik olaraq cari halın nüsxəsini də saxlayacaq.
                </strong>
              </p>
      ...
      {deleteModalOpen && snapshotToDelete && (
        <div className="admin-status-modal-backdrop" onClick={() => setDeleteModalOpen(false)}>
          <div
            className="admin-status-modal"
            onClick={(e) => e.stopPropagation()}
            style={{
