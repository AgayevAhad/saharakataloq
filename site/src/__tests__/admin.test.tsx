...
describe('Admin iş axınları', () => {
  it('WhatsApp, çoxsaylı zəng nömrələri və ünvan məlumatlarını qaralamaya daxil edib saxlayır', async () => {
    ...
    fireEvent.change(screen.getByPlaceholderText('994501234567'), {
      target: { value: '+994 50 111 22 33' },
    });
    ...
    fireEvent.change(screen.getAllByPlaceholderText('Tam ünvan')[0], {
      target: { value: 'Yeni Ünvan 123' },
    });
