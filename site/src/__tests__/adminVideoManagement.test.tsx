...
describe('Admin Video Media Management & Video First Placement', () => {
    ...
    media: [
      {
        id: 'm1',
        type: 'image',
        url: '/media/products/lotus-aspirator-2752.jpg',
        alt: 'Lotus Aspirator Şəkili',
      },
      {
        id: 'm2',
        type: 'video',
        url: '/media/products/videos/lotus-aspirator-2752.mp4',
        poster: '/media/products/lotus-aspirator-2752.jpg',
        alt: 'Lotus Aspirator Video Çarxı',
      },
    ],
    highlights: [],
    specs: [],
  ...
  it('renders video filter in CatalogAdmin and filters products by video presence', () => {
    ...
    const mediaFilterSelect = screen.getByTitle(
      /Şəkilli və ya şəkilsiz məhsullara görə süzgəc/i
